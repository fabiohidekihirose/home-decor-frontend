...
export default function Favorite() {
  ...
  return (
    <div className="flex max-lg:p-6 p-24 max-lg:pt-36 lg:pt-44 xl:pt-36 lg:space-x-[2%] text-[#000000] shadow-[0_4px_30px_rgba(157,157,157,0.25)] max-lg:space-y-[30px] w-full">
